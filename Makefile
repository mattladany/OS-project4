...
tar:
	make clean ; mkdir project04 ; cp Makefile project04/ ; cp README.md project04/ ; cp run.sh project04/ ; cp -r src project04/ ; cp bin/ project04/ ; tar -czf project04.tar.gz project04/
